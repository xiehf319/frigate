 ...
 */
package cn.cici.frigate.id.impl;

import cn.cici.frigate.id.BitsAllocator;
import cn.cici.frigate.id.UidGenerator;
import cn.cici.frigate.id.buffer.BufferPaddingExecutor;
import cn.cici.frigate.id.buffer.RejectedPutBufferHandler;
import cn.cici.frigate.id.buffer.RejectedTakeBufferHandler;
import cn.cici.frigate.id.buffer.RingBuffer;
 ...
 * <li><b>scheduleInterval:</b> Padding buffer in a task, specify padding buffer interval, Unit as second
