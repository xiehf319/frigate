package cn.cici.frigate.mqtt.starter.service;

import cn.cici.frigate.mqtt.starter.exception.SocketRuntimeException;
import cn.cici.frigate.mqtt.starter.future.InvokeFuture;
    ...
    private final ChannelFutureListener sendSuccessListener = new ChannelFutureListener() {
        ...
        public void operationComplete(ChannelFuture future) throws Exception {
            if (future.isSuccess()) {
                ...
                if (server != null) {
                    server.getCountInfo().getSendNum().incrementAndGet();
                    server.getCountInfo().setLastSend(System.currentTimeMillis());
                }
            }
        }
    };
